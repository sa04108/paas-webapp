// =============================================================================
// appAccessService.js - 앱 클라이언트 키(client key) 관리 서비스
// =============================================================================
// 역할:
//   개별 앱에 대한 접근 키를 발급하고 검증한다.
//   - client key 형식: client.<id>.<secret>
//   - scope: userid + appname 조합으로 특정 앱에만 유효
//   - 발급 시 1회만 원문 반환, 이후 해시만 저장
//   - bridge API (/bridge/...) 인증에 사용됨 (X-App-Key 헤더)
//   - SQLite(better-sqlite3)로 app_client_keys 테이블 관리
//
//   외부 시스템이나 유저의 스크립트에서 이 키를 통해
//   자기 앱의 상태를 조회하거나 시동할 수 있다.
// =============================================================================
"use strict";
